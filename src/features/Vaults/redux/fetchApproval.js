...
import { approval } from 'libs/web3';

export function fetchApproval({ address, web3, tokenAddress, contractAddress, tokenSymbol,DisplayNotification}) {
  return dispatch => {
    dispatch({
    ...
    const promise = new Promise((resolve, reject) => {
        ...
        .then(data => {
          console.log('Result of allowance :',data);
          dispatch({
