...
export const harvest = async ({ web3, address, vaultContractAddress, DisplayNotification,toadId }) => {
  ...
  const data = await _harvest({ contract: strategyContract, address, DisplayNotification,toadId });
  return data;
};

const _harvest = ({ contract, address, DisplayNotification,toadId }) => {
